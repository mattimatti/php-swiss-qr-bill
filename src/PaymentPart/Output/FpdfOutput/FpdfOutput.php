...
final class FpdfOutput extends AbstractOutput implements OutputInterface
{
    ...
    private function addSeparatorContentIfNotPrintable(): void
    {
        if (!$this->isPrintable()) {
            ...
            $this->fpdf->Line(2 + $this->offsetX, 192 + $this->offsetY, 208 + $this->offsetX, 192 + $this->offsetY);
            $this->fpdf->Line(62 + $this->offsetX, 192 + $this->offsetY, 62 + $this->offsetX, 296 + $this->offsetY);
            $this->fpdf->SetFont(self::FONT, '', self::FONT_SIZE_FURTHER_INFORMATION);
            $this->setY(189.6);
